...
# 2. TASK PARAMETERS
# ==========================================
T_total = 0.5  # Total time for the point-to-point motion
...
if __name__ == "__main__":
    ...
    # The rest of your execution code (minimize, printing, plotting) stays exactly the same!
    ...
    # ==========================================
    # 9. EXPORT DATA FOR ISAAC SIM
    # ==========================================
    import json
    import os

    print("\nExporting optimized data to JSON for Isaac Sim...")
    ...
    export_data = {
        ...
        "trajectory": {
            "positions": q_opt.tolist(),
            "velocities": v_opt.tolist()
        }
    }
    
    # Save to the same folder as your script
    save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ur5_optimized_data.json")
